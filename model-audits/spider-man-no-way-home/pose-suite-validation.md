# Spider-Man No Way Home pose-suite validation

- Status: `partial`
- Source: `generated-vrm`
...
| `walking_stride_proxy` | `pass` | structural mapping supports this proxy; visual review still required |
...
- Contact sheet: `model-working/spider-man-no-way-home/visual-review/contact-sheet.png`
- Visual review: `fail`
