# Avatar audit: elsa candidate VRM
...
- Selected source: `/home/o/posepuppet-working/generated-vrms/elsa.vrm`
- Selected format: `vrm`
- From ZIP: `False`
...
elsa candidate VRM uses generic/custom naming with 124 bones, 3 meshes, 2 skinned meshes, and label experimental. Upper body is good, legs are missing, hands are good, fingers are poor, and face-touch is possible_with_ik. License is unknown; verify before redistribution.
