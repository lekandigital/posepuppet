# Avatar audit: Woody runtime VRM
...
- Selected source: `public/avatars/woody.vrm`
- Selected format: `vrm`
- From ZIP: `False`
...
Woody runtime VRM uses Mixamo naming with 65 bones, 7 meshes, 6 skinned meshes, and label partial. Upper body is good, legs are good, hands are good, fingers are missing, and face-touch is possible_with_ik. License is unknown; verify before redistribution.
