// One Euro filter (Casiez et al. 2012) — ported from PosePuppet's
// src/pose/oneEuro.ts so the package carries no host-source dependency.
// Time comes exclusively from caller-supplied timestamps (determinism).
