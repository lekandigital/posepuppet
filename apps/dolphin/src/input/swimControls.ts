// Body → swim intents. Mirrors Flight's consumer discipline: BodySignal
// only (landmarks never reach this app), two transports (BroadcastChannel
// same-origin + postMessage envelope, deduped by ts), staleness/confidence
// gates, tracking-loss autopilot with slew-bounded re-entry, and keyboard
// ALWAYS wins while touched (WASD + Q/E depth + Shift kick + Space burst).
//
